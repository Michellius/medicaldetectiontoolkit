...
# ==============================================================================
# Configuration file for NLST experiment adapted from the LIDC experiment
# ==============================================================================
...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        ...
        self.class_dict = {1: 'malignant'}  # 0 is background.
        self.patient_class_of_interest = 1  # patient metrics are only plotted for one class.
        self.ap_match_ious = [0.1]  # list of ious to be evaluated for ap-scoring.

        self.model_selection_criteria = ['malignant_ap'] # criteria to average over for saving epochs.
    ...
    def add_mrcnn_configs(self):
        ...
        if self.model == 'retina_net' or self.model == 'retina_unet' or self.model == 'prob_detector':
            ...
            print('num_seg_class: {}'.format(self.num_seg_classes))
            print('head_class: {}'.format(self.head_classes))
